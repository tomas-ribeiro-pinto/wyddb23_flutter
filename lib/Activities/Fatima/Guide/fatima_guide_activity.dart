...
import 'fatima_guide_entry.dart';

class FatimaGuideActivity extends StatefulWidget {
  const FatimaGuideActivity({Key? key}) : super(key: key);

  @override
  State<FatimaGuideActivity> createState() => _FatimaGuideActivityState();
}

class _FatimaGuideActivityState extends State<FatimaGuideActivity> {
  ...
  void _getGuides() async {
    _guideModel = (await ApiCacheHelper.getFatimaGuides());
      ...
      child: Container(
        ...
        child: TextButton(
          onPressed: () => {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => FatimaGuideEntry(title: guide.getTranslatedTitleAttribute(currentLanguageCode), body: guide.getTranslatedBodyAttribute(currentLanguageCode))),
            )
          },
