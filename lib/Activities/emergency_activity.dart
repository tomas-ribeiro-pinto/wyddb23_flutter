...
class EmergencyActivity extends StatefulWidget {
  const EmergencyActivity({Key? key, required this.title, required this.body}) : super(key: key);

  final String title;
  final String body;

  @override
  State<EmergencyActivity> createState() => _EmergencyActivityState();
}

class _EmergencyActivityState extends State<EmergencyActivity> {
