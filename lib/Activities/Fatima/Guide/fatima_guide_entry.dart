...
class FatimaGuideEntry extends StatefulWidget {
  const FatimaGuideEntry({Key? key, required this.title, required this.body}) : super(key: key);

  final String title;
  final String body;

  @override
  State<FatimaGuideEntry> createState() => _FatimaGuideEntryState();
}

class _FatimaGuideEntryState extends State<FatimaGuideEntry> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        transform:  Matrix4.translationValues(-20.0, 0.0, 0.0),
          ...
          label: MyText(
            translation(context).guides.toUpperCase(),
            style: TextStyle(
