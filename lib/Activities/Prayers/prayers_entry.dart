...
class PrayersEntry extends StatefulWidget {
  const PrayersEntry({Key? key, required this.title, required this.body}) : super(key: key);

  final String title;
  final String body;

  @override
  State<PrayersEntry> createState() => _PrayersEntryState();
}

class _PrayersEntryState extends State<PrayersEntry> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        transform:  Matrix4.translationValues(-20.0, 0.0, 0.0),
          ...
          label: MyText(
            translation(context).dailyPrayers.toUpperCase(),
            style: TextStyle(
